...
public class KitchenActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView deviceList = (ListView) findViewById(R.id.deviceListKitchen);
        ...
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> listView, View item, int position, long id) {
                ...
                else
                {
                    ...
                    if(position==1)
                    {
                        Intent newActivity = new Intent(KitchenActivity.this, FanControlActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putString("room","3");
